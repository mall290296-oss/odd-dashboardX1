      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 md:py-12">
        ...
        {activeTab === "Diagnostic" && (
          <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in">
                        <p className="text-slate-500 text-lg max-w-3xl leading-relaxed">Bonjour! \r Dans cette section, vous devez remplir tous les champs avec les informations relatives à votre commune. \r Si vous ne disposez pas de toutes les informations pour le moment, vous pouvez également écrire « NA » et revenir plus tard pour les mettre à jour.</p>
